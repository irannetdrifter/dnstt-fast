...
[![Release](https://img.shields.io/github/v/release/irannetdrifter/dnstt-fast?style=flat-square)](https://github.com/irannetdrifter/dnstt-fast/releases)
...
```bash
curl -sLO https://raw.githubusercontent.com/irannetdrifter/dnstt-fast/main/dnstt-deploy.sh && sudo bash dnstt-deploy.sh
```
...
```bash
# Linux x64
curl -sLO https://github.com/irannetdrifter/dnstt-fast/releases/latest/download/dnstt-client-linux-amd64
chmod +x dnstt-client-linux-amd64

# macOS Apple Silicon
curl -sLO https://github.com/irannetdrifter/dnstt-fast/releases/latest/download/dnstt-client-darwin-arm64
...
| Platform | Download |
|----------|----------|
| Linux x64 | [`dnstt-client-linux-amd64`](https://github.com/irannetdrifter/dnstt-fast/releases/latest/download/dnstt-client-linux-amd64) |
| Linux ARM64 | [`dnstt-client-linux-arm64`](https://github.com/irannetdrifter/dnstt-fast/releases/latest/download/dnstt-client-linux-arm64) |
